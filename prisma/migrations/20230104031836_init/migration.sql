/*
  ...
  - You are about to alter the column `id` on the `Exercise` table. The data in that column will be cast from `BigInt` to `Int`. This cast may fail. Please make sure the data in the column can be cast.
